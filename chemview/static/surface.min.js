var ProteinSurface = function(n) {
    ...
    return this.initparm = function(i, n, v) {
        ...
        for (var n, o, r, t = new Array(13), s = 0; 13 > s; ++s)
            for (t[s] = i ? (A[s] + m) * b + .5 : A[s] * b + .5, r = t[s] * t[s], g[s] = Math.floor(t[s]) + 1, M[s] = new Array(g[s] * g[s]), indx = 0, j = 0; j < g[s]; ++j)
                            ...
                            for (kk = -1; 2 > kk; ++kk)
                                if (0 != ii && 0 != jj && 0 != kk)
                                    for (mi = ii * i, mk = kk * j, k = 0; k <= M[l][p]; ++k)
                                        if (mj = k * jj, si = u + mi, sj = y + mj, sk = h + mk, !(0 > si || 0 > sj || 0 > sk || si >= a || sj >= e || sk >= s)) {
                                            var w = f[si * e * s + sj * s + sk];
                                            if (0 == w.inout) w.inout = !0, w.atomid = n.serial;
                                            else if (w.inout) {
                                                var c = v[w.atomid];
                                                d = Math.floor(.5 + b * (c.coord.x + o)), x = Math.floor(.5 + b * (c.coord.y + r)), z = Math.floor(.5 + b * (c.coord.z + t)), d * d + x * x + z * z > mi * mi + mj * mj + mk * mk && (w.atomid = n.serial)
                                            }
                                        }
                p++
            }
                            ...
                            for (kk = -1; 2 > kk; ++kk)
                                if (0 != ii && 0 != jj && 0 != kk)
                                    for (mi = ii * i, mk = kk * j, k = 0; k <= M[l][z]; ++k)
                                        if (mj = k * jj, si = v + mi, sj = u + mj, sk = y + mk, !(0 > si || 0 > sj || 0 > sk)) {
                                            var p = f[si * e * s + sj * s + sk];
                                            if (0 == p.isdone) p.isdone = !0, p.atomid = n.serial;
                                            else if (p.isdone) {
                                                var w = a[p.atomid];
                                                h = Math.floor(.5 + b * (w.coord.x + o)), d = Math.floor(.5 + b * (w.coord.y + r)), x = Math.floor(.5 + b * (w.coord.z + t)), h * h + d * d + x * x > mi * mi + mj * mj + mk * mk && (p.atomid = n.serial)
                                            }
                                        }
                z++
            }
        ...
        for (var n = 0, o = f.length; o > n; ++n) 3 == i ? f[n].isbound = !1 : 4 == i ? (f[n].isdone = !1, f[n].isbound && (f[n].isdone = !0), f[n].isbound = !1) : 2 == i ? f[n].isbound && f[n].isdone ? f[n].isbound = !1 : f[n].isbound && !f[n].isdone && (f[n].isdone = !0) : 3 == i && (f[n].isbound = !1);
                            ...
                            if ((k || M || q) && (k || j || q) && (j || M || q) && (k || j || M) && (b || g || C) && (b || A || C) && (A || g || C) && (b || A || g) && (k || M || g) && (M || g || b) && (k || g || b) && (k || M || b) && (q || M || C) && (q || g || C) && (M || g || C) && (q || M || g) && (q || j || A) && (j || A || C) && (q || A || C) && (q || j || C) && (k || j || b) && (k || b || A) && (b || j || A) && (k || j || A))
                                if ((k || M || C) && (j || q || b) && (A || C || M) && (b || g || q) && (k || j || C) && (g || C || j) && (M || q || A) && (b || A || q) && (k || b || C) && (q || C || k) && (M || g || A) && (j || A || g)) {
                                    if (!((k || M || A) && (j || q || g) && (A || C || k) && (b || g || j) && (k || j || g) && (g || C || k) && (M || q || b) && (b || A || M) && (k || b || q) && (q || C || b) && (M || g || j) && (j || A || M))) {
                                        for (k || M || A ? j || q || g ? A || C || k ? b || g || j ? k || j || g ? g || C || k ? M || q || b ? b || A || M ? k || b || q ? q || C || b ? M || g || j ? j || A || M || (m[0][0] = n + 1, m[0][1] = y + 1, m[0][2] = d, m[1][0] = n, m[1][1] = y, m[1][2] = d, m[2][0] = n, m[2][1] = y, m[2][2] = d + 1, m[3][0] = n + 1, m[3][1] = y + 1, m[3][2] = d + 1, m[4][0] = n + 1, m[4][1] = y, m[4][2] = d + 1) : (m[0][0] = n, m[0][1] = y, m[0][2] = d, m[1][0] = n + 1, m[1][1] = y + 1, m[1][2] = d, m[2][0] = n + 1, m[2][1] = y + 1, m[2][2] = d + 1, m[3][0] = n, m[3][1] = y, m[3][2] = d + 1, m[4][0] = n, m[4][1] = y + 1, m[4][2] = d + 1) : (m[0][0] = n, m[0][1] = y + 1, m[0][2] = d + 1, m[1][0] = n + 1, m[1][1] = y, m[1][2] = d + 1, m[2][0] = n + 1, m[2][1] = y, m[2][2] = d, m[3][0] = n, m[3][1] = y + 1, m[3][2] = d, m[4][0] = n, m[4][1] = y, m[4][2] = d) : (m[0][0] = n, m[0][1] = y + 1, m[0][2] = d, m[1][0] = n + 1, m[1][1] = y, m[1][2] = d, m[2][0] = n + 1, m[2][1] = y, m[2][2] = d + 1, m[3][0] = n, m[3][1] = y + 1, m[3][2] = d + 1, m[4][0] = n + 1, m[4][1] = y + 1, m[4][2] = d + 1) : (m[0][0] = n, m[0][1] = y, m[0][2] = d, m[1][0] = n + 1, m[1][1] = y, m[1][2] = d + 1, m[2][0] = n + 1, m[2][1] = y + 1, m[2][2] = d + 1, m[3][0] = n, m[3][1] = y + 1, m[3][2] = d, m[4][0] = n + 1, m[4][1] = y + 1, m[4][2] = d) : (m[0][0] = n + 1, m[0][1] = y, m[0][2] = d + 1, m[1][0] = n, m[1][1] = y, m[1][2] = d, m[2][0] = n, m[2][1] = y + 1, m[2][2] = d, m[3][0] = n + 1, m[3][1] = y + 1, m[3][2] = d + 1, m[4][0] = n, m[4][1] = y + 1, m[4][2] = d + 1) : (m[0][0] = n, m[0][1] = y, m[0][2] = d + 1, m[1][0] = n + 1, m[1][1] = y, m[1][2] = d, m[2][0] = n + 1, m[2][1] = y + 1, m[2][2] = d, m[3][0] = n, m[3][1] = y + 1, m[3][2] = d + 1, m[4][0] = n, m[4][1] = y + 1, m[4][2] = d) : (m[1][0] = n, m[1][1] = y, m[1][2] = d + 1, m[0][0] = n + 1, m[0][1] = y, m[0][2] = d, m[3][0] = n + 1, m[3][1] = y + 1, m[3][2] = d, m[2][0] = n, m[2][1] = y + 1, m[2][2] = d + 1, m[4][0] = n + 1, m[4][1] = y + 1, m[4][2] = d + 1) : (m[0][0] = n, m[0][1] = y + 1, m[0][2] = d + 1, m[1][0] = n, m[1][1] = y, m[1][2] = d, m[2][0] = n + 1, m[2][1] = y, m[2][2] = d, m[3][0] = n + 1, m[3][1] = y + 1, m[3][2] = d + 1, m[4][0] = n + 1, m[4][1] = y + 1, m[4][2] = d) : (m[0][0] = n, m[0][1] = y + 1, m[0][2] = d, m[1][0] = n, m[1][1] = y, m[1][2] = d + 1, m[2][0] = n + 1, m[2][1] = y, m[2][2] = d + 1, m[3][0] = n + 1, m[3][1] = y + 1, m[3][2] = d, m[4][0] = n + 1, m[4][1] = y, m[4][2] = d) : (m[0][0] = n + 1, m[0][1] = y + 1, m[0][2] = d + 1, m[1][0] = n + 1, m[1][1] = y, m[1][2] = d, m[2][0] = n, m[2][1] = y, m[2][2] = d, m[3][0] = n, m[3][1] = y + 1, m[3][2] = d + 1, m[4][0] = n, m[4][1] = y, m[4][2] = d + 1) : (m[0][0] = n, m[0][1] = y, m[0][2] = d + 1, m[1][0] = n, m[1][1] = y + 1, m[1][2] = d, m[2][0] = n + 1, m[2][1] = y + 1, m[2][2] = d, m[3][0] = n + 1, m[3][1] = y, m[3][2] = d + 1, m[4][0] = n + 1, m[4][1] = y + 1, m[4][2] = d + 1), z = 0; 5 > z; ++z) - 1 == r[m[z][0]][m[z][1]][m[z][2]] && (r[m[z][0]][m[z][1]][m[z][2]] = v, w.push(new P(m[z][0], m[z][1], m[z][2])), v++);
...
onmessage = function(i) {
    postMessage(ProteinSurface(i.data))
};