...
var ChemviewView = widgets.DOMWidgetView.extend({
    ...
    update: function() {
        return ChemviewView.__super__.update.apply(
            this);
    },
    ...
    on_msg: function(msg) {
        ...
        return ChemviewView.__super__.update.apply(this);
    },
    ...
    remove: function() {
        ...
        ChemviewView.__super__.remove.apply(this)
    ...
    ndarrayToTypedArray: function(array) {
        var buffer = arraybuffer.decode(array['data']);
...
module.exports = {
    ChemviewModel : ChemviewModel,
    ChemviewView : ChemviewView
};
